...
void MainMenuInit(void)
{
	...
	StartButtonPosX = 800 - (ButtonSizeX+5.f)*2.f;//WindowCenterX + WindowCenterX/2.f - (ButtonSizeX / 2.f) ;
	StartButtonPosY = 900.f- (ButtonSizeY + 5.f) * 2.f;//WindowCenterY - (ButtonSizeY)-5.f;
	QuitButtonPosX = 800 + (ButtonSizeX + 5.f) * 1.f;//WindowCenterX + WindowCenterX / 2.f - (ButtonSizeX / 2.f);
	QuitButtonPosY = 900.f - (ButtonSizeY + 5.f) * 2.f;//WindowCenterY + (ButtonSizeY)+5.f;
	RankButtonPosX = 800 - (ButtonSizeX + 5.f) * 1.f;//WindowCenterX + WindowCenterX / 2.f - (ButtonSizeX / 2.f);
	RankButtonPosY = 900.f - (ButtonSizeY + 5.f) * 2.f;//WindowCenterY;
	HowToPlayButtonPosX = 800 + (ButtonSizeX + 5.f) * 0.f;
	HowToPlayButtonPosY = 900.f - (ButtonSizeY + 5.f) * 2.f;
	PlayMainMenuBGM();
...
void MainMenuUpdate(void)
{
	...
	//HowToPlayButton
	CP_Settings_Fill(CP_Color_Create(64, 64, 64, 255));
	CP_Image_Draw(UIBoard, HowToPlayButtonPosX, HowToPlayButtonPosY, ButtonSizeX, ButtonSizeY, 255);
	//CP_Graphics_DrawRect(RankButtonPosX, RankButtonPosY, ButtonSizeX, ButtonSizeY);
	CP_Settings_Fill(CP_Color_Create(0, 0, 0, 255));
